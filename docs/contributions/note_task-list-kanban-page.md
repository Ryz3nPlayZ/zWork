# Design and Architecture Note: Task List Kanban Page

Kanban task board page layout structure, drag and drop columns, and state synchronization.
...
## Details
This note provides guidelines and documentation on the handling of `Task List Kanban Page` in zWork.
