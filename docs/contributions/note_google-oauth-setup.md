# Design and Architecture Note: Google OAuth Setup

Desktop OAuth flow implementation details utilizing Better Auth and Axum callback redirection.
...
## Details
This note provides guidelines and documentation on the handling of `Google OAuth Setup` in zWork.
