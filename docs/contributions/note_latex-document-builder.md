# Design and Architecture Note: LaTeX Document Builder

Structuring abstract, related work, methodology, experiments, and conclusion into Markdown and LaTeX.
...
## Details
This note provides guidelines and documentation on the handling of `LaTeX Document Builder` in zWork.
