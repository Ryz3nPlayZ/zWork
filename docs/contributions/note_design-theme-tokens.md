# Design and Architecture Note: Design Theme Tokens

Modern-minimal design theme RGB values for paper, ink, line, and accent colors in light and dark mode.
...
## Details
This note provides guidelines and documentation on the handling of `Design Theme Tokens` in zWork.
