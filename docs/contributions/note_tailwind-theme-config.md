# Design and Architecture Note: Tailwind Theme Config

Configuring custom tailwind CSS variables to load paper/ink rgb tuples for dark mode compatibility.
...
## Details
This note provides guidelines and documentation on the handling of `Tailwind Theme Config` in zWork.
