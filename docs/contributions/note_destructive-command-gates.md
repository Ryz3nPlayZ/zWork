# Design and Architecture Note: Destructive Command Gates

Permission authorization flow with interactive terminal approvals for destructive CLI actions.
...
## Details
This note provides guidelines and documentation on the handling of `Destructive Command Gates` in zWork.
