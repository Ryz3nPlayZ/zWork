# Design and Architecture Note: DeepSeek Thinking Parser

LLM thinking token extraction from Anthropic-compatible tool stream payloads.
...
## Details
This note provides guidelines and documentation on the handling of `DeepSeek Thinking Parser` in zWork.
