# Design and Architecture Note: Onboarding Modal Architecture

Onboarding wizard layout, model provider credentials preflight, and routing flow.
...
## Details
This note provides guidelines and documentation on the handling of `Onboarding Modal Architecture` in zWork.
