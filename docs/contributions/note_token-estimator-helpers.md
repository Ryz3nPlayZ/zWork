# Design and Architecture Note: Token Estimator Helpers

Tiktoken estimation helpers for compacting chat histories before context bounds.
...
## Details
This note provides guidelines and documentation on the handling of `Token Estimator Helpers` in zWork.
