# Design and Architecture Note: Analytics Summary Dashboard

Analytics summary state mapping for quota usage, active runs, and provider health.
...
## Details
This note provides guidelines and documentation on the handling of `Analytics Summary Dashboard` in zWork.
