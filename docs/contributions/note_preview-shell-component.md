# Design and Architecture Note: Preview Shell Component

Preview components for demonstrating screens (login, onboarding, tasks) side-by-side.
...
## Details
This note provides guidelines and documentation on the handling of `Preview Shell Component` in zWork.
