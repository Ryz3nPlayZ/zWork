# Design and Architecture Note: Custom Skill Indexer

Discovery, slug generation, name and description metadata parsing from SKILL.md files.
...
## Details
This note provides guidelines and documentation on the handling of `Custom Skill Indexer` in zWork.
