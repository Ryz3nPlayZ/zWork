# Design and Architecture Note: Mac Drag Region Fixes

CSS drag region configuration to ensure window manipulation works across macOS versions.
...
## Details
This note provides guidelines and documentation on the handling of `Mac Drag Region Fixes` in zWork.
