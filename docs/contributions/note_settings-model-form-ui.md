# Design and Architecture Note: Settings Model Form UI

Settings panel model selection form validation and error surfacing styles.
...
## Details
This note provides guidelines and documentation on the handling of `Settings Model Form UI` in zWork.
