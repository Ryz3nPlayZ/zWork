# Design and Architecture Note: Markdown Rendering Bubble

Rendering markdown, Code blocks with syntax highlighting, and LaTeX equations in Chat.
...
## Details
This note provides guidelines and documentation on the handling of `Markdown Rendering Bubble` in zWork.
