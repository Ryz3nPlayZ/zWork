# Design and Architecture Note: Release Manifest Builder

Automated Tauri release updater JSON generator for secure signed auto-updates.
...
## Details
This note provides guidelines and documentation on the handling of `Release Manifest Builder` in zWork.
