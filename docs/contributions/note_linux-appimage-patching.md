# Design and Architecture Note: Linux AppImage Patching

Tauri AppImage binary patching script for compatibility across Linux distributions.
...
## Details
This note provides guidelines and documentation on the handling of `Linux AppImage Patching` in zWork.
