# Design and Architecture Note: Typography System

Typography configuration and system sans-serif fonts hierarchy used in Tailwind configuration.
...
## Details
This note provides guidelines and documentation on the handling of `Typography System` in zWork.
