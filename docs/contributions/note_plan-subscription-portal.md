# Design and Architecture Note: Plan Subscription Portal

Plan page subscription tiers, Stripe billing portal redirects, and access code redemption UI.
...
## Details
This note provides guidelines and documentation on the handling of `Plan Subscription Portal` in zWork.
