# Design and Architecture Note: Database Kysely Adapter

PostgreSQL database migrations and Kysely adapters for OAuth users table structures.
...
## Details
This note provides guidelines and documentation on the handling of `Database Kysely Adapter` in zWork.
