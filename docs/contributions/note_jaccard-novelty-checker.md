# Design and Architecture Note: Jaccard Novelty Checker

Novelty checking algorithm logic based on keyword Jaccard overlap similarity scoring.
...
## Details
This note provides guidelines and documentation on the handling of `Jaccard Novelty Checker` in zWork.
