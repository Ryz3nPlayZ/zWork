# Design and Architecture Note: Milestone Tracker Streamer

Meaningful milestone updates generator in streaming.py for long-running workflows.
...
## Details
This note provides guidelines and documentation on the handling of `Milestone Tracker Streamer` in zWork.
