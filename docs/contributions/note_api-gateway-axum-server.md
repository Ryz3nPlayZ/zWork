# Design and Architecture Note: API Gateway Axum Server

Axum routing configuration for user profile management and hosted router proxying.
...
## Details
This note provides guidelines and documentation on the handling of `API Gateway Axum Server` in zWork.
