# Design and Architecture Note: Skills Markdown Template

Required sections, tools schema, and guidelines in SKILL.md file design.
...
## Details
This note provides guidelines and documentation on the handling of `Skills Markdown Template` in zWork.
