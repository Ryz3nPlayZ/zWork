# Design and Architecture Note: Vite Production Bundler

Tauri frontend bundling script configuration using Vite, TypeScript, and postprocessing build steps.
...
## Details
This note provides guidelines and documentation on the handling of `Vite Production Bundler` in zWork.
