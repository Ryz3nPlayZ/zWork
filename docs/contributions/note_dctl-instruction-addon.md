# Design and Architecture Note: Dctl Instruction Addon

Context injection templates for giving agents system permissions to run dctl operations.
...
## Details
This note provides guidelines and documentation on the handling of `Dctl Instruction Addon` in zWork.
