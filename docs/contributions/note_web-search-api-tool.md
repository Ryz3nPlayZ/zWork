# Design and Architecture Note: Web Search API Tool

Local web scraping and news queries implementation using the browser reader and duckduckgo search.
...
## Details
This note provides guidelines and documentation on the handling of `Web Search API Tool` in zWork.
