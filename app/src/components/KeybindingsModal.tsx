...
export function KeybindingsModal() {
  ...
  const categories = [
    ...
    },
    {
      title: "View & Controls",
      shortcuts: [
        { keys: [`${cmdKey}`, "+"], desc: "Zoom In Page" },
        { keys: [`${cmdKey}`, "-"], desc: "Zoom Out Page" },
        { keys: [`${cmdKey}`, "0"], desc: "Reset Page Zoom" },
      ],
    },
  ];
  ...
  return (
    <div
      className="fixed inset-0 z-[1000] flex items-center justify-center bg-ink/30 animate-fade-in"
