<!--
  Vendored from pi-mono (https://github.com/badlogic/pi-mono), tag v0.87.1,
  packages/agent/docs/assistant-durability.md. MIT License, Copyright Mario Zechner.
  Normative spec for the harness port. Do not edit here; re-vendor on re-pin.
-->
